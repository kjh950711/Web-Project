        ...
        <div class="dashboard-wrapper">
          ...
          <div class="col-xl-1170px col-lg-1170px col-md-1170px col-sm-1170px col-1170px">
					<div class="container" style="margin-top:50px;">
					 <div class="row">
						<!-- <img src="resources/assets/images/top50.jpg" style="width:10%; height:10%"> -->
						<h1><i class="fas fa-chess-queen"></i> 경주마 TOP 50 </h1>
						...
						<tbody>
							<c:forEach items="${hlist}" var="hivo" varStatus="status">
									<tr>
										<td>${hivo.rownum}</td>
										<td><img src="${hivo.hPhoto}" class="rounded"
											alt="Cinque Terre" width="80" height="50"></td>
										<%-- <td><a href="/dark_horse/horse_detail?hrname=${hivo.hName}" >${hivo.hName}</a></td> --%>
										<td><a href="<%=request.getContextPath()%>/horse_detail?hName=${hivo.hName}" >${hivo.hName}</a></td>
										<td>${hivo.hno}</td>
										<td>${hivo.hSex}</td>
										<td>${hivo.hBirthday}</td>
										<td>${hivo.gamePlace}</td>
										<td>${hivo.hWinRate}%</td>
										<td>${hivo.hTrainingCnt}</td>
									</tr>
							</c:forEach>
						</tbody>
						</table>
