                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="user-avatar text-center d-block">
                                        <img src="${gvo.pPhoto}" alt="User Avatar" style="width:107px; height:144px" > 
                                       
                                    </div>
                                    <div class="text-center">
                                        <h2 class="font-24 mb-0">${gvo.pName}</h2> 
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="">
                                        ...
                                        <li class="mb-2">${gvo.pBirthday}</li> 
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <h1 class="mb-0">${gvo.pWinRateAll}%</h1> 
                                    <div class="rating-star">
                                        <c:set var="rate" value="${gvo.pWinRateAll}"/>
                                        <c:if test="${gvo.pWinRateAll >= 14}">
                                        ...
                                        <c:if test="${gvo.pWinRateAll < 14 && gvo.pWinRateAll >=11}">
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>
                                        ...
                                        <c:if test="${gvo.pWinRateAll < 11 && gvo.pWinRateAll >=8}">
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>
                                        <!-- <p class="d-inline-block text-dark">14 Reviews </p> -->
                                        </c:if>
                                        <c:if test="${gvo.pWinRateAll < 8 && gvo.pWinRateAll >=5}">
                                        <i class="fa fa-fw fa-star"></i>
                                        <i class="fa fa-fw fa-star"></i>

                                        <!-- <p class="d-inline-block text-dark">14 Reviews </p> -->
                                        </c:if>
                                        <c:if test="${gvo.pWinRateAll <5}">
                                        <i class="fa fa-fw fa-star"></i>
                               ...
                               <!--  <div class="card-body border-top">
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="">
                                        <ul class="list-unstyled mb-0">
                                         <img src="${gvo.pCloth}" style="width: 50%; hight:50%">
                                    </ul>
                                    </div>
                                </div> 
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                       <h1 class="mb-1">${gvo.pWeight}kg</h1> 
                                                        <p>기승가능중량</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1">${gvo.gamePlace}</h1> 
                                                        <p>지역</p>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="influencer-profile-data">
                                                                   <!--  <h3 class="m-b-10">전적</h3> -->
                                                                    ...
                                                                    <p>
                                                                     ...
                                                                     <c:if test="${not empty prizevo.pPrize}">
                                                                   		 <!-- 이부분이 반복돼서 뿌려지면 됨 --> 
                                                                       
                                                                        <span class="m-r-20 d-inline-block">경주명
                                                                            <span class="m-l-10 text-primary">${prizevo.pPrize}</span> 
                                                                        </span>
                                                                        <span class="m-r-20 d-inline-block">경주일자
                                                                            <span class="m-l-10 text-secondary">${prizevo.gameDate}</span> 
                                                                        </span>
                                                                            <span class="m-r-20 d-inline-block">마명  
                                                                            <span class="m-l-10  text-info">${prizevo.hName}</span> 
                                                                        </span>
                                         ...
                                         <c:forEach items="${prizelist}" var="prizevo"> 
                                            ...
                                            <div class="border-top card-footer p-0">
                                                <div class="campaign-metrics d-xl-inline-block" style="float:left; width:32%; ">
                                                    <h5 class="mb-0 ">통산</h5>
                                                    <p><span class="m-l-10 text-secondary">${gvo.pWinCntAll} </span></p> 
                                                </div>
                                                <div class="campaign-metrics d-xl-inline-block" style="float:left; width:27%; ">
                                                    <h5 class="mb-0 ">최근1년</h5>
                                                    <p><span class="m-l-10 text-primary">${gvo.pWinCntYear}</span></p> 
                                                </div>
                                                <div class="campaign-metrics d-xl-inline-block" style="float:left; width:20%; ">
                                                    <h5 class="mb-0">승률(통산)</h5>
                                                    <p><span class="m-l-10  text-info">${gvo.pWinRateAll}%</span></p> 
                                                </div>
                                         		<div class="campaign-metrics d-xl-inline-block" style="float:left; width:20%; ">
                                                    <h5 class="mb-0">승률(1년)</h5>
                                                    <p><span class="m-l-10  text-info">${gvo.pWinRateYear}%</span></p> 
                                                </div>
