					...
					<div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
						<div class="card"
								...
								<div class="card-body" style="margin-left: 20px;">
									<div class="campaign-metrics d-xl-inline-block">
										...
										<ul class="list-unstyled mb-0">
											<li class="font-20" style="text-align: center;">${hvo.hrname}</li>
										</ul>
									</div>
									...
									<div class="campaign-metrics d-xl-inline-block">
										...
										<ul class="list-unstyled mb-0">
											<li class="font-20" style="text-align: center;">${hvo.hrno}</li>
										</ul>
									</div>
								</div>
							</div>
							<div class="user-avatar text-center d-block"
								...
								<img src="${hvo.h_photo}" alt="User Avatar" width="400">
							</div>
							<div class="card-body border-top">
								<h3 class="font-16">
								...
								<div class="">
									<ul class="list-unstyled mb-0">
										<li class="font-20" style="margin-left: 80px;">${hvo.h_sex}</li>
									</ul>
								</div>
							</div>
							<div class="card-body border-top">
								...
								<div class="">
									<ul class="list-unstyled mb-0">
										<li class="font-20" style="margin-left: 80px;">${hvo.h_birthday}</li>
							...
							<div class="card-body border-top">
								...
								<div class="">
									<ul class="list-unstyled mb-0">
										<li class="font-20" style="margin-left: 80px";>${hvo.h_class}</li>
									...
									<div class="row">
										<div class="card"
											...
											<div class="card-body border-top"
												...
												<h3 class="font-22" style="text-align: left;">${hvo.h_prize}</h3>
											...
											<div class="card-body border-top"
												style="float =: right; height: 16%">
												<h3 class="font-22" style="text-align: left;">${hvo.h_win_rate}</h3>
												<div class="" align="right">
													<ul class="list-unstyled mb-0">
														<h3 class="font-12" style="text-align: left;">
															</i>승률
											...
											<div class="card-body border-top"
												style="float =: right; height: 16%">
												<h3 class="font-22" style="text-align: left;">${hvo.rating}</h3>
												<div class="" align="right">
													<ul class="list-unstyled mb-0">
														<h3 class="font-12" style="text-align: left;">
															</i>레이팅
											...
											<div class="card-body border-top"
												style="float =: right; height: 16%">
												<h3 class="font-22" style="text-align: left;">${hvo.training_cnt}</h3>
												<div class="" align="right">
													<ul class="list-unstyled mb-0">
														<h3 class="font-12" style="text-align: left;">
															</i>훈련횟수
											...
											<div class="card-body border-top"
												style="float =: right; height: 16%">
												<h3 class="font-22" style="text-align: left;">${hsvo.avgrank}</h3>
												<div class="" align="right">
													<ul class="list-unstyled mb-0">
														<h3 class="font-12" style="text-align: left;">
															</i>평균순위
...
var ctx = document.getElementById("radar").getContext('2d');
	<c:set var="place" value="${hvo.place}" />
    ...
    data: {
           ...
           datasets: [{
              label: "Ability",
               data: ["38","${hvo.h_win_rate}","${hvo.rating}", "32.4","${hsvo.gamecnt}","39.5"],
               backgroundColor: "rgba(255, 232, 23, 0.8)",
               borderColor:"#ffc400"
           }]
          },
    ...
    data: {
           ...
           datasets: [{
              label: "Ability",
               data: ["89", "${hvo.h_win_rate}","${hvo.rating}", "${hvo.training_cnt}","${hsvo.gamecnt}","16.4"],
